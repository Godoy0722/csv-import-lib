...
/**
 * @file plugins/importexport/csv/shared/handlers/WelcomeEmailHandler.php
 *
...
class WelcomeEmailHandler
{
    ...
    public static function sendWelcomeEmail(Context $context, User $recipient, User $sender, string $password)
    {
